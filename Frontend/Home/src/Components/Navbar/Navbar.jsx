...
export const Navbar = () => {
  ...
  <div>
    <Link to="/">
      <img src="https://iili.io/Jqq8OLx.png" alt="logo" />
    </Link>
  </div>
...
<img src="https://iili.io/JqqgmYB.th.png" 
alt="" />
...
<Menu isOpen={menu1.isOpen}>
            ...
            >
                Vegetables {menu1.isOpen ? <ChevronUpIcon /> : <ChevronDownIcon />}
            </MenuButton>
      ...
      <span>Micromax</span>
          ...
          <Menu isOpen={menu2.isOpen}>
            ...
            >
                Fruits {menu2.isOpen ? <ChevronUpIcon /> : <ChevronDownIcon />}
            </MenuButton>
...
{menu3.isOpen ? <ChevronUpIcon /> : <ChevronDownIcon />}
            </MenuButton>
